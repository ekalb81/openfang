...
- **Set up channels**: Connect any of 42 messaging platforms (Telegram, Discord, Slack, WhatsApp, LINE, Mastodon, and 36 more). See [Channel Adapters](channel-adapters).
...
- **Switch LLM providers**: 41 providers supported (Anthropic, OpenAI, Gemini, Groq, DeepSeek, xAI, Ollama, and more). Per-agent model overrides.
